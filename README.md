# ScratchNN
Building a two-layer deep neural network from scratch using only Python and NumPy — no external libraries — to classify handwritten digits from the MNIST dataset. Inspired and guided by Samson Zhang's video tutorial [https://www.youtube.com/watch?v=w8yWXqWQYmU&t=1697s]
